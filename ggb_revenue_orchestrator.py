#!/usr/bin/env python3
"""GGB Revenue Orchestrator - Sales Goal Agent"""
import json
import os
import sys
import time
...
print("=" * 60)
print("GGB REVENUE ORCHESTRATOR")
print("=" * 60)
...
if unpublished:
    ...
    for i, p in enumerate(unpublished):
        ...
        try:
            ...
            if e.code == 429:
                wait_time = 90  # Longer wait for rate limit
        ...
        if consecutive_failures >= 3:
            print(f"    Too many failures, backing off for 120s...")
            time.sleep(120)
            consecutive_failures = 0
