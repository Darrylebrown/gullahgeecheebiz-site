#!/usr/bin/env python3
"""
Gullah Geechee Biz — Distribution Bot 5: IngramSpark
Submits new ebooks to IngramSpark for bookstore distribution.
"""
...
def main():
    print("📚 IngramSpark Distribution Bot")
    print("   Checking for new ebooks to submit to IngramSpark...")
    
    state_file = STATE_DIR / "ingram-state.json"
    submitted = set()
    ...
    print(f"   📖 {len(pending)} ebook(s) pending IngramSpark submission")
    ...
    print(f"   ✅ {len(pending)} ebook(s) queued for IngramSpark")
    return 0
