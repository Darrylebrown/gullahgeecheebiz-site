...
RECIPES = [
    ...
    # ── Batch 4: More Depth (10) ──
    {
        "slug": "crab-cakes",
        "title": "Gullah Crab Cakes Recipe",
        "title_es": "Receta de Croquetas de Cangrejo Gullah",
        "description": "Golden, crispy crab cakes with fresh blue crab and Lowcountry seasonings. This Gullah crab cakes recipe is a coastal classic from the Sea Islands.",
        "description_es": "Croquetas de cangrejo doradas y crujientes con cangrejo azul fresco y condimentos de las Lowcountry.",
        "keywords": "crab cakes recipe, Gullah crab cakes, Lowcountry crab cakes, Charleston crab cakes, blue crab cakes",
        "keywords_es": "receta de croquetas de cangrejo, croquetas de cangrejo Gullah, croquetas de cangrejo Lowcountry",
        "prep_time": "PT15M", "cook_time": "PT12M", "total_time": "PT27M",
        "servings": 6, "calories": 320,
        "ingredients": ["1 lb fresh blue crab meat","1/2 cup breadcrumbs","1/4 cup mayonnaise","1 large egg, beaten","1 tbsp Dijon mustard","1 tbsp Worcestershire sauce","1 tsp Old Bay seasoning","1/2 tsp cayenne pepper","1/4 cup green onion, finely chopped","2 tbsp fresh parsley, chopped","1 tbsp lemon juice","Salt to taste","2 tbsp butter for frying","Lemon wedges for serving"],
        "ingredients_es": ["500g de carne de cangrejo azul fresco","1/2 taza de pan rallado","1/4 taza de mayonesa","1 huevo grande, batido","1 cucharada de mostaza Dijon","1 cucharada de salsa Worcestershire","1 cucharadita de condimento Old Bay","1/2 cucharadita de cayena","1/4 taza de cebolla verde finamente picada","2 cucharadas de perejil fresco picado","1 cucharada de jugo de limón","Sal al gusto","2 cucharadas de mantequilla para freír","Rodajas de limón para servir"],
        "instructions": ["Pick through crab meat to remove any shell fragments. Be careful not to break up the lumps.","In a large bowl, gently combine crab meat, breadcrumbs, mayonnaise, egg, mustard, Worcestershire, Old Bay, cayenne, green onion, parsley, and lemon juice. Mix gently — keep the crab lumps intact.","Form into 6 patties. Place on a baking sheet and refrigerate 30 minutes to firm up.","Melt butter in a large skillet over medium heat. Cook crab cakes 4-5 minutes per side until golden brown and crispy.","Serve hot with lemon wedges and remoulade sauce."],
        "instructions_es": ["Revise la carne de cangrejo para eliminar fragmentos de cáscara. Tenga cuidado de no romper los grumos.","En un tazón grande, combine suavemente la carne de cangrejo, el pan rallado, la mayonesa, el huevo, la mostaza, la Worcestershire, el Old Bay, la cayena, la cebolla verde, el perejil y el jugo de limón. Mezcle suavemente.","Forme 6 croquetas. Coloque en una bandeja para hornear y refrigere 30 minutos para que se firmen.","Derrita la mantequilla en una sartén grande a fuego medio. Cocine las croquetas 4-5 minutos por lado hasta que estén doradas y crujientes.","Sirva caliente con rodajas de limón y salsa remoulade."],
        "notes": "Chilling the crab cakes before frying is essential — it helps them hold together. Use jumbo lump crab meat for the best texture.",
        "notes_es": "Enfriar las croquetas antes de freírlas es esencial — ayuda a que se mantengan unidas. Use carne de cangrejo jumbo lump para la mejor textura.",
        "category": "Appetizer", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Crab Cakes — Golden Sea Islands Classic",
        "pinterest_desc": "Golden crispy crab cakes with fresh blue crab. A Gullah Geechee coastal classic from the Sea Islands."
    },
    {
        "slug": "okra-fries",
        "title": "Gullah Okra Fries Recipe",
        "title_es": "Receta de Papas Fritas de Okra Gullah",
        "description": "Crispy, seasoned okra fries baked or fried to perfection. This Gullah okra fries recipe turns a traditional vegetable into an irresistible snack.",
        "description_es": "Papas fritas de okra crujientes y sazonadas horneadas o fritas a la perfección. Convierte una verdura tradicional en un bocadillo irresistible.",
        "keywords": "okra fries recipe, Gullah okra fries, fried okra recipe, crispy okra, Lowcountry snack, baked okra fries",
        "keywords_es": "receta de papas fritas de okra, papas fritas de okra Gullah, receta de okra frita, okra crujiente",
        "prep_time": "PT10M", "cook_time": "PT15M", "total_time": "PT25M",
        "servings": 4, "calories": 180,
        "ingredients": ["1 lb fresh okra, cut into 1/2-inch strips lengthwise","1/2 cup cornmeal","1/4 cup all-purpose flour","1 tsp garlic powder","1 tsp smoked paprika","1/2 tsp cayenne pepper","1 tsp salt","1/2 tsp black pepper","1 cup buttermilk","Vegetable oil for frying or 2 tbsp olive oil for baking","Ranch dressing or remoulade for dipping"],
        "ingredients_es": ["500g de okra fresca, cortada en tiras de 1 cm a lo largo","1/2 taza de harina de maíz","1/4 taza de harina","1 cucharadita de ajo en polvo","1 cucharadita de pimentón ahumado","1/2 cucharadita de cayena","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1 taza de suero de leche","Aceite vegetal para freír o 2 cucharadas de aceite de oliva para hornear","Aderezo ranch o remoulade para mojar"],
        "instructions": ["Soak okra strips in buttermilk for 10 minutes.","In a shallow dish, combine cornmeal, flour, garlic powder, smoked paprika, cayenne, salt, and pepper.","For frying: Heat 1 inch of oil in a skillet to 350°F. Dredge okra in cornmeal mixture and fry 3-4 minutes until golden. Drain on paper towels.","For baking: Preheat oven to 425°F. Toss okra with olive oil, then dredge in cornmeal mixture. Spread on baking sheet and bake 12-15 minutes, flipping halfway.","Serve hot with ranch or remoulade for dipping."],
        "instructions_es": ["Remoje las tiras de okra en suero de leche durante 10 minutos.","En un plato poco profundo, combine la harina de maíz, la harina, el ajo en polvo, el pimentón ahumado, la cayena, la sal y la pimienta.","Para freír: Caliente 2.5 cm de aceite en una sartén a 175°C. Pase la okra por la mezcla de harina de maíz y fría 3-4 minutos hasta que esté dorada.","Para hornear: Precaliente el horno a 220°C. Mezcle la okra con aceite de oliva, luego pase por la mezcla de harina de maíz. Hornee 12-15 minutos, volteando a la mitad.","Sirva caliente con aderezo ranch o remoulade para mojar."],
        "notes": "The buttermilk soak helps the coating stick and reduces the okra's sliminess. Baking is healthier, but frying gives the best crunch.",
        "notes_es": "El remojo en suero de leche ayuda a que el recubrimiento se adhiera y reduce la baba de la okra. Hornear es más saludable, pero freír da el mejor crujiente.",
        "category": "Snack", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Okra Fries — Crispy Lowcountry Snack",
        "pinterest_desc": "Crispy seasoned okra fries baked or fried. A Gullah Geechee snack that turns okra into something irresistible."
    },
    {
        "slug": "gullah-meatloaf",
        "title": "Gullah Meatloaf Recipe",
        "title_es": "Receta de Pastel de Carne Gullah",
        "description": "Savory meatloaf with a sweet and tangy glaze. This Gullah meatloaf recipe is Sunday dinner comfort food that feeds a crowd.",
        "description_es": "Pastel de carne sabroso con un glaseado dulce y picante. La comida reconfortante de la cena dominical que alimenta a una multitud.",
        "keywords": "meatloaf recipe, Gullah meatloaf, Southern meatloaf, Lowcountry meatloaf, comfort food, Sunday dinner recipe",
        "keywords_es": "receta de pastel de carne, pastel de carne Gullah, pastel de carne sureño, pastel de carne Lowcountry",
        "prep_time": "PT15M", "cook_time": "PT1H", "total_time": "PT1H15M",
        "servings": 8, "calories": 420,
        "ingredients": ["2 lbs ground beef (80/20)","1 cup breadcrumbs","1 large onion, finely diced","1 green bell pepper, finely diced","2 cloves garlic, minced","2 large eggs","1/2 cup milk","1 tbsp Worcestershire sauce","1 tsp salt","1/2 tsp black pepper","1 tsp smoked paprika","1/2 tsp cayenne pepper","1/4 cup ketchup","2 tbsp brown sugar","1 tbsp apple cider vinegar"],
        "ingredients_es": ["1 kg de carne molida (80/20)","1 taza de pan rallado","1 cebolla grande, finamente picada","1 pimiento verde, finamente picado","2 dientes de ajo, picados","2 huevos grandes","1/2 taza de leche","1 cucharada de salsa Worcestershire","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1 cucharadita de pimentón ahumado","1/2 cucharadita de cayena","1/4 taza de ketchup","2 cucharadas de azúcar moreno","1 cucharada de vinagre de sidra de manzana"],
        "instructions": ["Preheat oven to 350°F. Line a baking sheet with foil.","In a large bowl, combine ground beef, breadcrumbs, onion, bell pepper, garlic, eggs, milk, Worcestershire, salt, pepper, smoked paprika, and cayenne. Mix until just combined — do not overwork.","Shape into a loaf on the prepared baking sheet.","In a small bowl, mix ketchup, brown sugar, and vinegar for the glaze. Spread half over the meatloaf.","Bake 45 minutes. Spread remaining glaze on top. Bake 15 more minutes until internal temperature reaches 160°F.","Let rest 10 minutes before slicing. Serve with mashed potatoes and collard greens."],
        "instructions_es": ["Precaliente el horno a 175°C. Cubra una bandeja para hornear con papel aluminio.","En un tazón grande, combine la carne molida, el pan rallado, la cebolla, el pimiento, el ajo, los huevos, la leche, la Worcestershire, la sal, la pimienta, el pimentón ahumado y la cayena. Mezcle hasta que estén combinados.","Forme un pan en la bandeja preparada.","En un tazón pequeño, mezcle el ketchup, el azúcar moreno y el vinagre para el glaseado. Unte la mitad sobre el pastel de carne.","Hornee 45 minutos. Unte el glaseado restante encima. Hornee 15 minutos más hasta que la temperatura interna alcance 71°C.","Deje reposar 10 minutos antes de rebanar. Sirva con puré de papas y berzas."],
        "notes": "Don't overmix the meatloaf or it will be tough. The brown sugar glaze is what makes this Gullah version special — sweet, tangy, and caramelized.",
        "notes_es": "No mezcle demasiado el pastel de carne o quedará duro. El glaseado de azúcar moreno es lo que hace especial esta versión Gullah.",
        "category": "Main Dish", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Meatloaf — Sunday Dinner Comfort Food",
        "pinterest_desc": "Savory meatloaf with a sweet and tangy brown sugar glaze. Gullah Geechee Sunday dinner comfort food."
    },
    {
        "slug": "gullah-potato-salad",
        "title": "Gullah Potato Salad Recipe",
        "title_es": "Receta de Ensalada de Papas Gullah",
        "description": "Creamy, tangy, with a hint of mustard and sweet pickle relish. This Gullah potato salad recipe is the essential side for every Lowcountry cookout.",
        "description_es": "Cremosa, picante, con un toque de mostaza y relish de pepinillos dulces. El acompañamiento esencial para cada comida al aire libre de las Lowcountry.",
        "keywords": "potato salad recipe, Gullah potato salad, Southern potato salad, Lowcountry potato salad, soul food potato salad",
        "keywords_es": "receta de ensalada de papas, ensalada de papas Gullah, ensalada de papas sureña, ensalada de papas Lowcountry",
        "prep_time": "PT15M", "cook_time": "PT20M", "total_time": "PT35M",
        "servings": 8, "calories": 280,
        "ingredients": ["3 lbs Yukon Gold potatoes","4 large eggs, hard-boiled","1 cup mayonnaise","2 tbsp yellow mustard","1/4 cup sweet pickle relish","1/2 cup celery, finely diced","1/2 cup red onion, finely diced","1 tsp salt","1/2 tsp black pepper","1 tsp smoked paprika","1 tbsp apple cider vinegar","2 tbsp fresh parsley, chopped","Paprika for garnish"],
        "ingredients_es": ["1.5 kg de papas Yukon Gold","4 huevos grandes, duros","1 taza de mayonesa","2 cucharadas de mostaza amarilla","1/4 taza de relish de pepinillos dulces","1/2 taza de apio finamente picado","1/2 taza de cebolla roja finamente picada","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1 cucharadita de pimentón ahumado","1 cucharada de vinagre de sidra de manzana","2 cucharadas de perejil fresco picado","Pimentón para decorar"],
        "instructions": ["Place potatoes in a large pot and cover with cold salted water. Bring to a boil and cook 15-20 minutes until fork-tender. Drain and let cool slightly.","Peel potatoes while still warm (use a towel to hold them). Cut into 1-inch cubes.","Chop hard-boiled eggs.","In a large bowl, whisk together mayonnaise, mustard, relish, vinegar, salt, pepper, and smoked paprika.","Add warm potatoes, chopped eggs, celery, and red onion. Fold gently until combined.","Taste and adjust seasoning. Transfer to a serving bowl. Sprinkle with paprika and parsley.","Cover and refrigerate at least 2 hours before serving. The flavors meld overnight."],
        "instructions_es": ["Coloque las papas en una olla grande y cubra con agua fría con sal. Lleve a ebullición y cocine 15-20 minutos hasta que estén tiernas. Escurra y deje enfriar ligeramente.","Pele las papas mientras aún estén calientes. Corte en cubos de 2.5 cm.","Pique los huevos duros.","En un tazón grande, bata la mayonesa, la mostaza, el relish, el vinagre, la sal, la pimienta y el pimentón ahumado.","Agregue las papas tibias, los huevos picados, el apio y la cebolla roja. Doble suavemente hasta que estén combinados.","Pruebe y ajuste la sazón. Transfiera a un tazón para servir. Espolvoree con pimentón y perejil.","Cubra y refrigere al menos 2 horas antes de servir. Los sabores se mezclan durante la noche."],
        "notes": "The warm potatoes absorb the dressing better than cold ones. This salad is even better the next day — make it ahead for the best flavor.",
        "notes_es": "Las papas tibias absorben mejor el aderezo que las frías. Esta ensalada es aún mejor al día siguiente.",
        "category": "Side Dish", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Potato Salad — Creamy Lowcountry Cookout Side",
        "pinterest_desc": "Creamy tangy potato salad with mustard and sweet relish. The essential Gullah Geechee cookout side dish."
    },
    {
        "slug": "gullah-banana-pudding",
        "title": "Gullah Banana Pudding Recipe",
        "title_es": "Receta de Pudín de Plátano Gullah",
        "description": "Layers of vanilla wafers, fresh bananas, and creamy pudding topped with meringue. This Gullah banana pudding recipe is the ultimate Southern dessert.",
        "description_es": "Capas de galletas de vainilla, plátanos frescos y pudín cremoso cubierto con merengue. El postre sureño definitivo.",
        "keywords": "banana pudding recipe, Gullah banana pudding, Southern banana pudding, Lowcountry dessert, homemade banana pudding",
        "keywords_es": "receta de pudín de plátano, pudín de plátano Gullah, pudín de plátano sureño, postre Lowcountry",
        "prep_time": "PT20M", "cook_time": "PT15M", "total_time": "PT35M",
        "servings": 10, "calories": 360,
        "ingredients": ["1 cup sugar","1/4 cup cornstarch","1/2 tsp salt","4 cups whole milk","4 large egg yolks","2 tsp vanilla extract","2 tbsp butter","1 box vanilla wafers (about 12 oz)","4 ripe bananas, sliced","4 large egg whites","1/4 tsp cream of tartar","6 tbsp sugar (for meringue)"],
        "ingredients_es": ["1 taza de azúcar","1/4 taza de maicena","1/2 cucharadita de sal","4 tazas de leche entera","4 yemas de huevo","2 cucharaditas de extracto de vainilla","2 cucharadas de mantequilla","1 caja de galletas de vainilla","4 plátanos maduros, en rodajas","4 claras de huevo","1/4 cucharadita de crémor tártaro","6 cucharadas de azúcar (para el merengue)"],
        "instructions": ["In a medium saucepan, whisk together sugar, cornstarch, and salt. Gradually whisk in milk.","Cook over medium heat, stirring constantly, until thickened and bubbly, about 8 minutes.","In a small bowl, beat egg yolks. Gradually whisk 1 cup of hot milk mixture into yolks, then pour back into saucepan.","Cook 2 more minutes, stirring constantly. Remove from heat. Stir in vanilla and butter.","Layer vanilla wafers, sliced bananas, and pudding in a 9x13 dish. Repeat layers, ending with pudding on top.","Preheat oven to 350°F. Beat egg whites and cream of tartar until soft peaks form. Gradually add 6 tbsp sugar, beating until stiff peaks.","Spread meringue over pudding, sealing to edges. Bake 10-12 minutes until golden brown.","Cool completely, then refrigerate at least 4 hours before serving."],
        "instructions_es": ["En una cacerola mediana, bata el azúcar, la maicena y la sal. Incorpore gradualmente la leche.","Cocine a fuego medio, revolviendo constantemente, hasta que espese y burbujee, unos 8 minutos.","En un tazón pequeño, bata las yemas. Incorpore gradualmente 1 taza de la mezcla caliente de leche en las yemas, luego vierta de nuevo en la cacerola.","Cocine 2 minutos más, revolviendo constantemente. Retire del fuego. Incorpore la vainilla y la mantequilla.","Coloque capas de galletas de vainilla, plátanos en rodajas y pudín en un molde de 9x13. Repita las capas, terminando con pudín encima.","Precaliente el horno a 175°C. Bata las claras y el crémor tártaro hasta que se formen picos suaves. Agregue gradualmente 6 cucharadas de azúcar, batiendo hasta que se formen picos firmes.","Extienda el merengue sobre el pudín, sellando los bordes. Hornee 10-12 minutos hasta que esté dorado.","Enfríe completamente, luego refrigere al menos 4 horas antes de servir."],
        "notes": "The meringue topping is what makes this Gullah banana pudding special — don't skip it. Make it a day ahead for the best flavor as the wafers soften into cake-like layers.",
        "notes_es": "El merengue es lo que hace especial este pudín de plátano Gullah — no lo salte. Prepárelo el día anterior.",
        "category": "Dessert", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Banana Pudding — Ultimate Southern Dessert",
        "pinterest_desc": "Layers of vanilla wafers, bananas, and creamy pudding topped with golden meringue."
    },
    {
        "slug": "gullah-chicken-soup",
        "title": "Gullah Chicken and Rice Soup Recipe",
        "title_es": "Receta de Sopa de Pollo con Arroz Gullah",
        "description": "Hearty chicken and rice soup with Lowcountry vegetables and herbs. This Gullah chicken soup recipe is the cold-weather remedy that Gullah grandmothers swear by.",
        "description_es": "Sopa abundante de pollo con arroz con verduras y hierbas de las Lowcountry. El remedio de invierno que las abuelas Gullah recomiendan.",
        "keywords": "chicken and rice soup recipe, Gullah chicken soup, Lowcountry chicken soup, homemade chicken soup, Southern chicken soup",
        "keywords_es": "receta de sopa de pollo con arroz, sopa de pollo Gullah, sopa de pollo Lowcountry, sopa de pollo sureña",
        "prep_time": "PT15M", "cook_time": "PT1H", "total_time": "PT1H15M",
        "servings": 8, "calories": 310,
        "ingredients": ["1 whole chicken (3-4 lbs), cut into pieces","2 tbsp vegetable oil","1 large onion, diced","3 carrots, diced","3 celery stalks, diced","3 cloves garlic, minced","8 cups chicken broth","1 cup long-grain rice","2 bay leaves","1 tsp thyme","1 tsp smoked paprika","1/2 tsp turmeric","1 tsp salt","1/2 tsp black pepper","1/4 cup fresh parsley, chopped","2 tbsp fresh dill, chopped (optional)"],
        "ingredients_es": ["1 pollo entero (1.5-2 kg), cortado en piezas","2 cucharadas de aceite vegetal","1 cebolla grande, picada","3 zanahorias, picadas","3 tallos de apio, picados","3 dientes de ajo, picados","8 tazas de caldo de pollo","1 taza de arroz de grano largo","2 hojas de laurel","1 cucharadita de tomillo","1 cucharadita de pimentón ahumado","1/2 cucharadita de cúrcuma","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1/4 taza de perejil fresco picado","2 cucharadas de eneldo fresco picado (opcional)"],
        "instructions": ["Season chicken pieces with salt and pepper. Heat oil in a large pot over medium-high heat.","Brown chicken in batches, about 4 minutes per side. Remove and set aside.","Add onion, carrots, and celery to the pot. Cook until softened, about 6 minutes. Add garlic and cook 1 minute.","Return chicken to the pot. Add broth, bay leaves, thyme, smoked paprika, and turmeric. Bring to a boil.","Reduce heat and simmer 30 minutes until chicken is cooked through.","Remove chicken pieces. Let cool slightly, then shred meat, discarding skin and bones.","Return shredded chicken to the pot. Add rice. Simmer 18-20 minutes until rice is tender.","Remove bay leaves. Stir in parsley and dill. Season to taste. Serve hot."],
        "instructions_es": ["Sazone las piezas de pollo con sal y pimienta. Caliente el aceite en una olla grande a fuego medio-alto.","Dore el pollo en tandas, unos 4 minutos por lado. Retire y reserve.","Agregue la cebolla, las zanahorias y el apio a la olla. Cocine hasta que estén suaves, unos 6 minutos. Agregue el ajo y cocine 1 minuto.","Vuelva a poner el pollo en la olla. Agregue el caldo, las hojas de laurel, el tomillo, el pimentón ahumado y la cúrcuma. Lleve a ebullición.","Reduzca el fuego y cocine a fuego lento 30 minutos hasta que el pollo esté cocido.","Retire las piezas de pollo. Deje enfriar ligeramente, luego desmenuce la carne.","Vuelva a poner el pollo desmenuzado en la olla. Agregue el arroz. Cueza 18-20 minutos hasta que el arroz esté tierno.","Retire las hojas de laurel. Incorpore el perejil y el eneldo. Sazone al gusto. Sirva caliente."],
        "notes": "This soup gets better as it sits. The rice will absorb more liquid overnight, so add extra broth when reheating. Gullah grandmothers add a pinch of turmeric for color and health.",
        "notes_es": "Esta sopa mejora al reposar. El arroz absorberá más líquido durante la noche, así que agregue caldo extra al recalentar.",
        "category": "Soup", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Chicken and Rice Soup — Lowcountry Cold-Weather Remedy",
        "pinterest_desc": "Hearty chicken and rice soup with Lowcountry vegetables. The Gullah Geechee cold-weather remedy."
    },
    {
        "slug": "gullah-cabbage",
        "title": "Gullah Fried Cabbage Recipe",
        "title_es": "Receta de Repollo Frito Gullah",
        "description": "Smoky, savory fried cabbage with bacon and onions. This Gullah fried cabbage recipe is the quick side dish that goes with everything.",
        "description_es": "Repollo frito ahumado y sabroso con tocino y cebollas. El acompañamiento rápido que va con todo.",
        "keywords": "fried cabbage recipe, Gullah cabbage, Southern fried cabbage, Lowcountry cabbage, soul food cabbage, bacon cabbage",
        "keywords_es": "receta de repollo frito, repollo frito Gullah, repollo frito sureño, repollo frito Lowcountry",
        "prep_time": "PT10M", "cook_time": "PT15M", "total_time": "PT25M",
        "servings": 4, "calories": 200,
        "ingredients": ["1 head green cabbage, cored and chopped","6 slices bacon, chopped","1 large onion, diced","2 cloves garlic, minced","1 tsp salt","1/2 tsp black pepper","1/2 tsp red pepper flakes","1 tbsp apple cider vinegar","1 tsp sugar"],
        "ingredients_es": ["1 repollo verde, sin corazón y picado","6 rebanadas de tocino, picado","1 cebolla grande, picada","2 dientes de ajo, picados","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1/2 cucharadita de hojuelas de pimiento rojo","1 cucharada de vinagre de sidra de manzana","1 cucharadita de azúcar"],
        "instructions": ["Cook bacon in a large skillet over medium heat until crispy. Remove bacon, leaving drippings.","Add onion to drippings and cook until softened, about 4 minutes. Add garlic and cook 1 minute.","Add cabbage in batches, stirring until wilted before adding more.","Season with salt, black pepper, and red pepper flakes. Cook 8-10 minutes, stirring occasionally, until cabbage is tender and slightly caramelized.","Stir in vinegar and sugar. Return bacon to the skillet. Cook 2 more minutes.","Taste and adjust seasoning. Serve hot."],
        "instructions_es": ["Cocine el tocino en una sartén grande a fuego medio hasta que esté crujiente. Retire el tocino, dejando la grasa.","Agregue la cebolla a la grasa y cocine hasta que esté suave, unos 4 minutos. Agregue el ajo y cocine 1 minuto.","Agregue el repollo en lotes, revolviendo hasta que se marchite antes de agregar más.","Sazone con sal, pimienta negra y hojuelas de pimiento rojo. Cocine 8-10 minutos, revolviendo ocasionalmente, hasta que el repollo esté tierno y ligeramente caramelizado.","Incorpore el vinagre y el azúcar. Vuelva a poner el tocino en la sartén. Cocine 2 minutos más.","Pruebe y ajuste la sazón. Sirva caliente."],
        "notes": "The vinegar and sugar balance the cabbage's natural bitterness. This is the fastest side dish in the Gullah Geechee kitchen — ready in 25 minutes.",
        "notes_es": "El vinagre y el azúcar equilibran el amargor natural del repollo. Este es el acompañamiento más rápido en la cocina Gullah Geechee.",
        "category": "Side Dish", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Fried Cabbage — Quick Smoky Lowcountry Side",
        "pinterest_desc": "Smoky fried cabbage with bacon and onions. The quick Gullah Geechee side dish that goes with everything."
    },
    {
        "slug": "gullah-pork-chops",
        "title": "Gullah Smothered Pork Chops Recipe",
        "title_es": "Receta de Chuletas de Cerdo Ahogadas Gullah",
        "description": "Thick pork chops smothered in a rich onion gravy. This Gullah smothered pork chops recipe is the ultimate Lowcountry comfort food.",
        "description_es": "Chuletas de cerdo gruesas ahogadas en una rica salsa de cebolla. La comida reconfortante definitiva de las Lowcountry.",
        "keywords": "smothered pork chops recipe, Gullah pork chops, Southern smothered pork chops, Lowcountry pork chops, onion gravy pork chops",
        "keywords_es": "receta de chuletas de cerdo ahogadas, chuletas de cerdo Gullah, chuletas de cerdo sureñas ahogadas",
        "prep_time": "PT15M", "cook_time": "PT45M", "total_time": "PT1H",
        "servings": 4, "calories": 480,
        "ingredients": ["4 bone-in pork chops (1-inch thick)","1 tsp salt","1/2 tsp black pepper","1 tsp smoked paprika","1/2 cup all-purpose flour","3 tbsp vegetable oil","2 large onions, thinly sliced","3 cloves garlic, minced","2 cups chicken broth","1 tsp thyme","1/2 tsp cayenne pepper","2 bay leaves","1 tbsp apple cider vinegar","Fresh parsley for garnish"],
        "ingredients_es": ["4 chuletas de cerdo con hueso (2.5 cm de grosor)","1 cucharadita de sal","1/2 cucharadita de pimienta negra","1 cucharadita de pimentón ahumado","1/2 taza de harina","3 cucharadas de aceite vegetal","2 cebollas grandes, en rodajas finas","3 dientes de ajo, picados","2 tazas de caldo de pollo","1 cucharadita de tomillo","1/2 cucharadita de cayena","2 hojas de laurel","1 cucharada de vinagre de sidra de manzana","Perejil fresco para decorar"],
        "instructions": ["Season pork chops with salt, pepper, and smoked paprika. Dredge in flour, shaking off excess. Reserve remaining flour.","Heat oil in a large skillet over medium-high heat. Brown pork chops 3-4 minutes per side. Remove and set aside.","Add sliced onions to the skillet. Cook until deeply caramelized, about 10 minutes. Add garlic and cook 1 minute.","Sprinkle 2 tbsp of the reserved flour over onions. Stir and cook 2 minutes.","Slowly whisk in chicken broth, thyme, cayenne, and bay leaves. Bring to a simmer.","Return pork chops to the skillet, nestling into the gravy. Cover and reduce heat to low.","Simmer 25-30 minutes until pork is tender and cooked through.","Stir in vinegar. Remove bay leaves. Garnish with parsley. Serve with rice or mashed potatoes."],
        "instructions_es": ["Sazone las chuletas de cerdo con sal, pimienta y pimentón ahumado. Pase por harina.","Caliente el aceite en una sartén grande a fuego medio-alto. Dore las chuletas 3-4 minutos por lado. Retire y reserve.","Agregue las cebollas en rodajas a la sartén. Cocine hasta que estén profundamente caramelizadas, unos 10 minutos. Agregue el ajo y cocine 1 minuto.","Espolvoree 2 cucharadas de la harina reservada sobre las cebollas. Revuelva y cocine 2 minutos.","Incorpore lentamente el caldo de pollo, el tomillo, la cayena y las hojas de laurel. Lleve a fuego lento.","Vuelva a poner las chuletas en la sartén. Tape y reduzca el fuego a bajo.","Cueza a fuego lento 25-30 minutos hasta que el cerdo esté tierno.","Incorpore el vinagre. Retire las hojas de laurel. Decore con perejil. Sirva con arroz o puré de papas."],
        "notes": "The key to smothered pork chops is patience — let the onions caramelize deeply and the meat simmer low and slow. Serve with rice to soak up the gravy.",
        "notes_es": "La clave de las chuletas ahogadas es la paciencia — deje que las cebollas se caramelicen profundamente y la carne se cocine lentamente.",
        "category": "Main Dish", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Smothered Pork Chops — Rich Onion Gravy Comfort Food",
        "pinterest_desc": "Thick pork chops smothered in a rich onion gravy. The ultimate Gullah Geechee comfort food."
    },
    {
        "slug": "gullah-egg-salad",
        "title": "Gullah Egg Salad Recipe",
        "title_es": "Receta de Ensalada de Huevos Gullah",
        "description": "Classic egg salad with a Gullah twist — a hint of mustard, sweet relish, and smoked paprika. This egg salad recipe is perfect for sandwiches or crackers.",
        "description_es": "Ensalada de huevos clásica con un toque Gullah — un toque de mostaza, relish dulce y pimentón ahumado. Perfecta para sándwiches o galletas.",
        "keywords": "egg salad recipe, Gullah egg salad, Southern egg salad, Lowcountry egg salad, classic egg salad, deviled egg salad",
        "keywords_es": "receta de ensalada de huevos, ensalada de huevos Gullah, ensalada de huevos sureña, ensalada de huevos Lowcountry",
        "prep_time": "PT10M", "cook_time": "PT12M", "total_time": "PT22M",
        "servings": 4, "calories": 250,
        "ingredients": ["8 large eggs","1/3 cup mayonnaise","1 tbsp yellow mustard","2 tbsp sweet pickle relish","1/4 cup celery, finely diced","2 tbsp red onion, finely diced","1/2 tsp salt","1/4 tsp black pepper","1/2 tsp smoked paprika","1 tsp apple cider vinegar","Fresh dill or parsley for garnish"],
        "ingredients_es": ["8 huevos grandes","1/3 taza de mayonesa","1 cucharada de mostaza amarilla","2 cucharadas de relish de pepinillos dulces","1/4 taza de apio finamente picado","2 cucharadas de cebolla roja finamente picada","1/2 cucharadita de sal","1/4 cucharadita de pimienta negra","1/2 cucharadita de pimentón ahumado","1 cucharadita de vinagre de sidra de manzana","Eneldo o perejil fresco para decorar"],
        "instructions": ["Place eggs in a saucepan and cover with cold water. Bring to a boil, then cover and remove from heat. Let stand 10 minutes.","Transfer eggs to an ice bath. Cool completely, then peel.","Chop eggs into small pieces.","In a bowl, mix mayonnaise, mustard, relish, vinegar, salt, pepper, and smoked paprika.","Fold in chopped eggs, celery, and red onion until combined.","Chill at least 30 minutes before serving. Garnish with dill or parsley. Serve on bread, toast, or crackers."],
        "instructions_es": ["Coloque los huevos en una cacerola y cubra con agua fría. Lleve a ebullición, luego tape y retire del fuego. Deje reposar 10 minutos.","Transfiera los huevos a un baño de hielo. Enfríe completamente, luego pele.","Pique los huevos en trozos pequeños.","En un tazón, mezcle la mayonesa, la mostaza, el relish, el vinagre, la sal, la pimienta y el pimentón ahumado.","Incorpore los huevos picados, el apio y la cebolla roja hasta que estén combinados.","Enfríe al menos 30 minutos antes de servir. Decore con eneldo o perejil. Sirva en pan, tostadas o galletas."],
        "notes": "The perfect hard-boiled egg has a bright yellow yolk with no green ring. The smoked paprika is the Gullah touch that sets this apart from ordinary egg salad.",
        "notes_es": "El huevo duro perfecto tiene una yema amarilla brillante sin anillo verde. El pimentón ahumado es el toque Gullah que distingue esta ensalada.",
        "category": "Lunch", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Egg Salad — Classic with a Smoky Lowcountry Twist",
        "pinterest_desc": "Classic egg salad with mustard, relish, and smoked paprika. The Gullah Geechee twist on a lunch staple."
    },
    {
        "slug": "gullah-pimento-cheese",
        "title": "Gullah Pimento Cheese Recipe",
        "title_es": "Receta de Queso con Pimiento Gullah",
        "description": "Sharp, creamy, with a hint of heat. This Gullah pimento cheese recipe is the spread that every Lowcountry kitchen keeps ready for company.",
        "description_es": "Fuerte, cremoso, con un toque de picante. La crema para untar que cada cocina de las Lowcountry tiene lista para las visitas.",
        "keywords": "pimento cheese recipe, Gullah pimento cheese, Southern pimento cheese, Lowcountry pimento cheese, homemade pimento cheese",
        "keywords_es": "receta de queso con pimiento, queso con pimiento Gullah, queso con pimiento sureño, queso con pimiento Lowcountry",
        "prep_time": "PT10M", "cook_time": "PT0M", "total_time": "PT10M",
        "servings": 8, "calories": 280,
        "ingredients": ["2 cups sharp cheddar cheese, shredded","1 cup Monterey Jack cheese, shredded","1/2 cup mayonnaise","1 jar (4 oz) diced pimentos, drained","2 tbsp cream cheese, softened","1 tsp garlic powder","1/2 tsp cayenne pepper","1/2 tsp smoked paprika","1/2 tsp salt","1/4 tsp black pepper","1 tsp apple cider vinegar","1 tbsp fresh chives or green onion, chopped"],
        "ingredients_es": ["2 tazas de queso cheddar rallado","1 taza de queso Monterey Jack rallado","1/2 taza de mayonesa","1 frasco (120g) de pimientos morrones picados, escurridos","2 cucharadas de queso crema, ablandado","1 cucharadita de ajo en polvo","1/2 cucharadita de cayena","1/2 cucharadita de pimentón ahumado","1/2 cucharadita de sal","1/4 cucharadita de pimienta negra","1 cucharadita de vinagre de sidra de manzana","1 cucharada de cebollino o cebolla verde picada"],
        "instructions": ["In a large bowl, combine cheddar, Monterey Jack, mayonnaise, pimentos, cream cheese, garlic powder, cayenne, smoked paprika, salt, pepper, and vinegar.","Mix until well combined. The texture should be creamy but slightly chunky.","Fold in chives or green onion.","Taste and adjust seasoning. Refrigerate at least 1 hour before serving to let flavors meld.","Serve on crackers, as a sandwich spread, or stuffed into mini sweet peppers."],
        "instructions_es": ["En un tazón grande, combine el cheddar, el Monterey Jack, la mayonesa, los pimientos, el queso crema, el ajo en polvo, la cayena, el pimentón ahumado, la sal, la pimienta y el vinagre.","Mezcle hasta que esté bien combinado. La textura debe ser cremosa pero ligeramente grumosa.","Incorpore el cebollino o la cebolla verde.","Pruebe y ajuste la sazón. Refrigere al menos 1 hora antes de servir para que los sabores se mezclen.","Sirva con galletas, como untar para sándwiches o relleno en pimientos dulces pequeños."],
        "notes": "Grate your own cheese — pre-shredded cheese has anti-caking agents that affect the texture. This keeps in the refrigerator for up to a week.",
        "notes_es": "Ralle su propio queso — el queso pre-rallado tiene agentes antiaglomerantes que afectan la textura. Se conserva en el refrigerador hasta por una semana.",
        "category": "Appetizer", "cuisine": "Gullah Geechee",
        "pinterest_title": "Gullah Pimento Cheese — Sharp Creamy Lowcountry Spread",
        "pinterest_desc": "Sharp creamy pimento cheese with a hint of heat. The Gullah Geechee spread every Lowcountry kitchen keeps ready."
    }
]
