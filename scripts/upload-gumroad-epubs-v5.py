...
Fixes parameter naming for presign endpoint.
"""
...
def upload_file_presign(epub_path):
    ...
    # Step 1: Get presign URL - use 'filename' parameter
    ...
    log(f"  Got presign URL, uploading to S3...")
    ...
    if r.status_code not in [200, 204]:
        return None, f"S3 upload failed: {r.status_code} - {r.text[:200]}"
    ...
    log(f"  File URL obtained: {file_url}")
...
def main():
    ...
    log("=" * 60)
    log("Gumroad EPUB Upload V5 (Presign Flow Fixed)")
    log("=" * 60)
