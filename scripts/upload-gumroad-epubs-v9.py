...
Fixed: Each product upload is independent (no overwriting).
"""
...
LOG_FILE = LOG_DIR / "upload_epub_v9.log"
...
def main():
    ...
    log("=" * 60)
    log("Gumroad EPUB Upload V9 (Independent Uploads)")
    log("=" * 60)
    ...
    # Save matches
    with open(LOG_DIR / "matches_v9.json", "w") as f:
        json.dump(matches, f, indent=2)
    log(f"Saved {len(matches)} matches to matches_v9.json")
