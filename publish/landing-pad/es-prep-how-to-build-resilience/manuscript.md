# How to Build Resilience — Versión en Español
...
## Introducción
Bienvenido a how to build resilience. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Resilience no es solo una habilidad — es un viaje.
