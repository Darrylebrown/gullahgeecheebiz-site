# How to Build Optimism — Versión en Español
...
## Introducción
Bienvenido a how to build optimism. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Optimism no es solo una habilidad — es un viaje.
