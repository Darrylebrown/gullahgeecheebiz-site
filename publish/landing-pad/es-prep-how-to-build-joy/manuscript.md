# How to Build Joy — Versión en Español
...
## Introducción
Bienvenido a how to build joy. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Joy no es solo una habilidad — es un viaje.
