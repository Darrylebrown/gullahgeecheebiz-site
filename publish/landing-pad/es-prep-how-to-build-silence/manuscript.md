# How to Build Silence — Versión en Español
...
## Introducción
Bienvenido a how to build silence. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Silence no es solo una habilidad — es un viaje.
