# How to Build Simplicity — Versión en Español
...
## Introducción
Bienvenido a how to build simplicity. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Simplicity no es solo una habilidad — es un viaje.
