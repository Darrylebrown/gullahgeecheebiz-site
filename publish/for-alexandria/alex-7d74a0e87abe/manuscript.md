# How to Build an Email List from Scratch — Versión en Español
...
## Introducción
Bienvenido a how to build an email list from scratch. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build an Email List from Scratch no es solo una habilidad — es un viaje.
