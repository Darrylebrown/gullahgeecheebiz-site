# How to Build Change — Versión en Español
...
## Introducción
Bienvenido a how to build change. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Change no es solo una habilidad — es un viaje.
