# How to Build Purpose — Versión en Español
...
## Introducción
Bienvenido a how to build purpose. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Purpose no es solo una habilidad — es un viaje.
