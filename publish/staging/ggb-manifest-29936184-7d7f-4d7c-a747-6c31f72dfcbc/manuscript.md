# How to Build Kindness — Versión en Español
...
## Introducción
Bienvenido a how to build kindness. Esta guía se basa en la sabiduría del pueblo Gullah Geechee.
...
## Conclusión
How to Build Kindness no es solo una habilidad — es un viaje.
